...
test.describe('Deposit Transaction Tests', () => {
  ...
  const dateTimeNow = getDateTimeString(); // Function to verify that date and time of deposit
...
test('Verify if user is able to complete a withdraw transaction.', async ({ page }, testInfo) => {
  ...
  const remainingBalance = depositAmount - withdrawAmount; // Compute for the remaining balance, initial balance minus withdraw amount
